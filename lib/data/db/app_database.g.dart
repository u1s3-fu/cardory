...
class $ProjectProgressEntriesTable extends ProjectProgressEntries
    with TableInfo<$ProjectProgressEntriesTable, ProjectProgressEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ProjectProgressEntriesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'project_progress_entries';
  @override
  VerificationContext validateIntegrity(
    Insertable<ProjectProgressEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ProjectProgressEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $ProjectProgressEntriesTable createAlias(String alias) {
    return $ProjectProgressEntriesTable(attachedDatabase, alias);
  }
}

class ProjectProgressEntry extends DataClass
    implements Insertable<ProjectProgressEntry> {
  final String id;
  ...
  ProjectProgressEntriesCompanion toCompanion(bool nullToAbsent) {
    return ProjectProgressEntriesCompanion(
      id: Value(id),
  ...
  factory ProjectProgressEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ProjectProgressEntry copyWithCompanion(ProjectProgressEntriesCompanion data) {
    return ProjectProgressEntry(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('ProjectProgressEntry(')
          ..write('id: $id, ')
...
class ProjectProgressEntriesCompanion
    extends UpdateCompanion<ProjectProgressEntry> {
  final Value<String> id;
  ...
  final Value<int?> deletedAt;
  final Value<int> rowid;
  const ProjectProgressEntriesCompanion({
    this.id = const Value.absent(),
  ...
  ProjectProgressEntriesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<ProjectProgressEntry> custom({
    Expression<String>? id,
  ...
  ProjectProgressEntriesCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('ProjectProgressEntriesCompanion(')
          ..write('id: $id, ')
          ..write('projectId: $projectId, ')
          ..write('progress: $progress, ')
          ..write('note: $note, ')
...
class $AssetsTable extends Assets with TableInfo<$AssetsTable, Asset> {
  ...
  static const VerificationMeta _uriOrPathMeta = const VerificationMeta(
    'uriOrPath',
  );
  @override
  late final GeneratedColumn<String> uriOrPath = GeneratedColumn<String>(
    'uri_or_path',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _sensitiveJsonMeta = const VerificationMeta(
    'sensitiveJson',
  );
  @override
  late final GeneratedColumn<String> sensitiveJson = GeneratedColumn<String>(
    'sensitive_json',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('uri_or_path')) {
      context.handle(
        _uriOrPathMeta,
        uriOrPath.isAcceptableOrUnknown(data['uri_or_path']!, _uriOrPathMeta),
      );
    }
    if (data.containsKey('note')) {
      context.handle(
    ...
    if (data.containsKey('sensitive_json')) {
      context.handle(
        _sensitiveJsonMeta,
        sensitiveJson.isAcceptableOrUnknown(
          data['sensitive_json']!,
          _sensitiveJsonMeta,
        ),
      );
  ...
  Asset map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Asset(
      ...
      uriOrPath: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}uri_or_path'],
      )!,
      note: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}note'],
      ...
      sensitiveJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sensitive_json'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}created_at'],
...
class Asset extends DataClass implements Insertable<Asset> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['title'] = Variable<String>(title);
    map['uri_or_path'] = Variable<String>(uriOrPath);
    map['note'] = Variable<String>(note);
    map['tags_json'] = Variable<String>(tagsJson);
    map['metadata_json'] = Variable<String>(metadataJson);
    map['is_local_only'] = Variable<bool>(isLocalOnly);
    if (!nullToAbsent || sensitiveJson != null) {
      map['sensitive_json'] = Variable<String>(sensitiveJson);
    }
    map['created_at'] = Variable<int>(createdAt);
    map['updated_at'] = Variable<int>(updatedAt);
    if (!nullToAbsent || deletedAt != null) {
  ...
  AssetsCompanion toCompanion(bool nullToAbsent) {
    return AssetsCompanion(
      ...
      sensitiveJson: sensitiveJson == null && nullToAbsent
          ? const Value.absent()
          : Value(sensitiveJson),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
  ...
  factory Asset.fromJson(
    ...
    return Asset(
      ...
      title: serializer.fromJson<String>(json['title']),
      uriOrPath: serializer.fromJson<String>(json['uriOrPath']),
      note: serializer.fromJson<String>(json['note']),
      tagsJson: serializer.fromJson<String>(json['tagsJson']),
      metadataJson: serializer.fromJson<String>(json['metadataJson']),
      isLocalOnly: serializer.fromJson<bool>(json['isLocalOnly']),
      sensitiveJson: serializer.fromJson<String?>(json['sensitiveJson']),
      createdAt: serializer.fromJson<int>(json['createdAt']),
      updatedAt: serializer.fromJson<int>(json['updatedAt']),
      deletedAt: serializer.fromJson<int?>(json['deletedAt']),
    );
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'title': serializer.toJson<String>(title),
      'uriOrPath': serializer.toJson<String>(uriOrPath),
      'note': serializer.toJson<String>(note),
      'tagsJson': serializer.toJson<String>(tagsJson),
      'metadataJson': serializer.toJson<String>(metadataJson),
      'isLocalOnly': serializer.toJson<bool>(isLocalOnly),
      'sensitiveJson': serializer.toJson<String?>(sensitiveJson),
      'createdAt': serializer.toJson<int>(createdAt),
      'updatedAt': serializer.toJson<int>(updatedAt),
      'deletedAt': serializer.toJson<int?>(deletedAt),
    };
  ...
  Asset copyWith({
    ...
    String? metadataJson,
    bool? isLocalOnly,
    Value<String?> sensitiveJson = const Value.absent(),
    int? createdAt,
    int? updatedAt,
    Value<int?> deletedAt = const Value.absent(),
  }) => Asset(
    ...
    sensitiveJson: sensitiveJson.present
        ? sensitiveJson.value
        : this.sensitiveJson,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
  ...
  Asset copyWithCompanion(AssetsCompanion data) {
    return Asset(
      ...
      title: data.title.present ? data.title.value : this.title,
      uriOrPath: data.uriOrPath.present ? data.uriOrPath.value : this.uriOrPath,
      note: data.note.present ? data.note.value : this.note,
      ...
      isLocalOnly: data.isLocalOnly.present
          ...
          : this.isLocalOnly,
      sensitiveJson: data.sensitiveJson.present
          ? data.sensitiveJson.value
          : this.sensitiveJson,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      deletedAt: data.deletedAt.present ? data.deletedAt.value : this.deletedAt,
  ...
  String toString() {
    return (StringBuffer('Asset(')
          ...
          ..write('type: $type, ')
          ..write('title: $title, ')
          ..write('uriOrPath: $uriOrPath, ')
          ..write('note: $note, ')
          ..write('tagsJson: $tagsJson, ')
          ..write('metadataJson: $metadataJson, ')
          ..write('isLocalOnly: $isLocalOnly, ')
          ..write('sensitiveJson: $sensitiveJson, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt')
          ..write(')'))
  ...
  bool operator ==(Object other) =>
      ...
      (other is Asset &&
          ...
          other.title == this.title &&
          other.uriOrPath == this.uriOrPath &&
          other.note == this.note &&
          other.tagsJson == this.tagsJson &&
          other.metadataJson == this.metadataJson &&
          other.isLocalOnly == this.isLocalOnly &&
          other.sensitiveJson == this.sensitiveJson &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt &&
          other.deletedAt == this.deletedAt);
}
...
class AssetsCompanion extends UpdateCompanion<Asset> {
  ...
  final Value<String> title;
  final Value<String> uriOrPath;
  final Value<String> note;
  final Value<String> tagsJson;
  final Value<String> metadataJson;
  final Value<bool> isLocalOnly;
  final Value<String?> sensitiveJson;
  final Value<int> createdAt;
  final Value<int> updatedAt;
  final Value<int?> deletedAt;
  final Value<int> rowid;
  const AssetsCompanion({
    ...
    this.title = const Value.absent(),
    this.uriOrPath = const Value.absent(),
    this.note = const Value.absent(),
    this.tagsJson = const Value.absent(),
    this.metadataJson = const Value.absent(),
    this.isLocalOnly = const Value.absent(),
    this.sensitiveJson = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.deletedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  ...
  static Insertable<Asset> custom({
    ...
    Expression<String>? title,
    Expression<String>? uriOrPath,
    Expression<String>? note,
    Expression<String>? tagsJson,
    Expression<String>? metadataJson,
    Expression<bool>? isLocalOnly,
    Expression<String>? sensitiveJson,
    Expression<int>? createdAt,
    Expression<int>? updatedAt,
    Expression<int>? deletedAt,
    Expression<int>? rowid,
    ...
    return RawValuesInsertable({
      ...
      if (title != null) 'title': title,
      if (uriOrPath != null) 'uri_or_path': uriOrPath,
      if (note != null) 'note': note,
      if (tagsJson != null) 'tags_json': tagsJson,
      if (metadataJson != null) 'metadata_json': metadataJson,
      if (isLocalOnly != null) 'is_local_only': isLocalOnly,
      if (sensitiveJson != null) 'sensitive_json': sensitiveJson,
      if (createdAt != null) 'created_at': createdAt,
      if (updatedAt != null) 'updated_at': updatedAt,
      if (deletedAt != null) 'deleted_at': deletedAt,
      if (rowid != null) 'rowid': rowid,
  ...
  AssetsCompanion copyWith({
    ...
    Value<String>? type,
    Value<String>? title,
    Value<String>? uriOrPath,
    Value<String>? note,
    Value<String>? tagsJson,
    Value<String>? metadataJson,
    Value<bool>? isLocalOnly,
    Value<String?>? sensitiveJson,
    Value<int>? createdAt,
    Value<int>? updatedAt,
    Value<int?>? deletedAt,
    Value<int>? rowid,
    ...
    return AssetsCompanion(
      ...
      metadataJson: metadataJson ?? this.metadataJson,
      isLocalOnly: isLocalOnly ?? this.isLocalOnly,
      sensitiveJson: sensitiveJson ?? this.sensitiveJson,
      createdAt: createdAt ?? this.createdAt,
      updatedAt: updatedAt ?? this.updatedAt,
      deletedAt: deletedAt ?? this.deletedAt,
      rowid: rowid ?? this.rowid,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (uriOrPath.present) {
      map['uri_or_path'] = Variable<String>(uriOrPath.value);
    }
    if (note.present) {
      map['note'] = Variable<String>(note.value);
    }
    ...
    if (sensitiveJson.present) {
      map['sensitive_json'] = Variable<String>(sensitiveJson.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<int>(createdAt.value);
    }
...
class $AttachmentCategoriesTable extends AttachmentCategories
    with TableInfo<$AttachmentCategoriesTable, AttachmentCategory> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AttachmentCategoriesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'attachment_categories';
  @override
  VerificationContext validateIntegrity(
    Insertable<AttachmentCategory> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AttachmentCategory map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $AttachmentCategoriesTable createAlias(String alias) {
    return $AttachmentCategoriesTable(attachedDatabase, alias);
  }
}

class AttachmentCategory extends DataClass
    implements Insertable<AttachmentCategory> {
  final String id;
  final String projectId;
  final String name;
  final int createdAt;
  ...
  AttachmentCategoriesCompanion toCompanion(bool nullToAbsent) {
    return AttachmentCategoriesCompanion(
      id: Value(id),
      projectId: Value(projectId),
      name: Value(name),
      createdAt: Value(createdAt),
  ...
  factory AttachmentCategory.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AttachmentCategory copyWithCompanion(AttachmentCategoriesCompanion data) {
    return AttachmentCategory(
      id: data.id.present ? data.id.value : this.id,
      projectId: data.projectId.present ? data.projectId.value : this.projectId,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('AttachmentCategory(')
          ..write('id: $id, ')
          ..write('projectId: $projectId, ')
          ..write('name: $name, ')
          ..write('createdAt: $createdAt, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, projectId, name, createdAt, updatedAt, deletedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AttachmentCategory &&
          other.id == this.id &&
          other.projectId == this.projectId &&
          other.name == this.name &&
          other.createdAt == this.createdAt &&
...
class AttachmentCategoriesCompanion
    extends UpdateCompanion<AttachmentCategory> {
  final Value<String> id;
  final Value<String> projectId;
  final Value<String> name;
  final Value<int> createdAt;
  ...
  final Value<int?> deletedAt;
  final Value<int> rowid;
  const AttachmentCategoriesCompanion({
    this.id = const Value.absent(),
    this.projectId = const Value.absent(),
    this.name = const Value.absent(),
    this.createdAt = const Value.absent(),
  ...
  AttachmentCategoriesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<AttachmentCategory> custom({
    Expression<String>? id,
    Expression<String>? projectId,
    Expression<String>? name,
    Expression<int>? createdAt,
  ...
  AttachmentCategoriesCompanion copyWith({
    Value<String>? id,
    Value<String>? projectId,
    Value<String>? name,
    Value<int>? createdAt,
  ...
  @override
  String toString() {
    return (StringBuffer('AttachmentCategoriesCompanion(')
          ..write('id: $id, ')
          ..write('projectId: $projectId, ')
          ..write('name: $name, ')
          ..write('createdAt: $createdAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ProjectProgressEntriesTable projectProgressEntries =
      $ProjectProgressEntriesTable(this);
  late final $TasksTable tasks = $TasksTable(this);
  late final $AssetsTable assets = $AssetsTable(this);
  late final $AssetTagsTable assetTags = $AssetTagsTable(this);
  late final $AttachmentCategoriesTable attachmentCategories =
      $AttachmentCategoriesTable(this);
...
final class $$ProjectsTableReferences
  ...
  static MultiTypedResultKey<
    $ProjectProgressEntriesTable,
    List<ProjectProgressEntry>
  >
  _projectProgressEntriesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.projectProgressEntries,
        aliasName: 'projects__id__project_progress_entries__project_id',
      );

  $$ProjectProgressEntriesTableProcessedTableManager
  get projectProgressEntriesRefs {
    final manager = $$ProjectProgressEntriesTableTableManager(
      $_db,
      $_db.projectProgressEntries,
    ).filter((f) => f.projectId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _projectProgressEntriesRefsTable($_db),
    );
  ...
  static MultiTypedResultKey<$AssetsTable, List<Asset>> _assetsRefsTable(
    ...
    db.assets,
    aliasName: 'projects__id__assets__project_id',
  );
  ...
  >
  _attachmentCategoriesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.attachmentCategories,
        aliasName: 'projects__id__attachment_categories__project_id',
      );

  $$AttachmentCategoriesTableProcessedTableManager
  get attachmentCategoriesRefs {
    final manager = $$AttachmentCategoriesTableTableManager(
      $_db,
      $_db.attachmentCategories,
    ).filter((f) => f.projectId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _attachmentCategoriesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  _pomodoroSessionsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.pomodoroSessions,
    aliasName: 'projects__id__pomodoro_sessions__project_id',
  );
...
class $$ProjectsTableFilterComposer
  ...
  Expression<bool> projectProgressEntriesRefs(
    Expression<bool> Function($$ProjectProgressEntriesTableFilterComposer f) f,
  ) {
    final $$ProjectProgressEntriesTableFilterComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.projectProgressEntries,
          ...
          builder:
              ...
              }) => $$ProjectProgressEntriesTableFilterComposer(
                $db: $db,
                $table: $db.projectProgressEntries,
  ...
  Expression<bool> attachmentCategoriesRefs(
    Expression<bool> Function($$AttachmentCategoriesTableFilterComposer f) f,
  ) {
    final $$AttachmentCategoriesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.attachmentCategories,
      getReferencedColumn: (t) => t.projectId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$AttachmentCategoriesTableFilterComposer(
            $db: $db,
            $table: $db.attachmentCategories,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ProjectsTableAnnotationComposer
  ...
  Expression<T> projectProgressEntriesRefs<T extends Object>(
    Expression<T> Function($$ProjectProgressEntriesTableAnnotationComposer a) f,
  ) {
    final $$ProjectProgressEntriesTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.projectProgressEntries,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$ProjectProgressEntriesTableAnnotationComposer(
                $db: $db,
                $table: $db.projectProgressEntries,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
  ...
  Expression<T> attachmentCategoriesRefs<T extends Object>(
    Expression<T> Function($$AttachmentCategoriesTableAnnotationComposer a) f,
  ) {
    final $$AttachmentCategoriesTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.attachmentCategories,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$AttachmentCategoriesTableAnnotationComposer(
                $db: $db,
                $table: $db.attachmentCategories,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            bool projectProgressEntriesRefs,
            bool tasksRefs,
            bool assetsRefs,
            bool attachmentCategoriesRefs,
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                projectProgressEntriesRefs = false,
                tasksRefs = false,
                assetsRefs = false,
                attachmentCategoriesRefs = false,
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    if (projectProgressEntriesRefs) db.projectProgressEntries,
                    if (tasksRefs) db.tasks,
                    if (assetsRefs) db.assets,
                    if (attachmentCategoriesRefs) db.attachmentCategories,
                    ...
                    return [
                      if (projectProgressEntriesRefs)
                        ...
                        >(
                          ...
                          referencedTable: $$ProjectsTableReferences
                              ._projectProgressEntriesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$ProjectsTableReferences(
                                db,
                                table,
                                p0,
                              ).projectProgressEntriesRefs,
                      ...
                      if (attachmentCategoriesRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$ProjectsTableReferences
                              ._attachmentCategoriesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$ProjectsTableReferences(
                                db,
                                table,
                                p0,
                              ).attachmentCategoriesRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.projectId == item.id,
                              ),
...
typedef $$ProjectsTableProcessedTableManager =
    ...
    >;
typedef $$ProjectProgressEntriesTableCreateCompanionBuilder =
    ProjectProgressEntriesCompanion Function({
      required String id,
      required String projectId,
      required double progress,
      Value<String> note,
...
typedef $$ProjectProgressEntriesTableUpdateCompanionBuilder =
    ProjectProgressEntriesCompanion Function({
      Value<String> id,
      Value<String> projectId,
      Value<double> progress,
...
final class $$ProjectProgressEntriesTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $ProjectProgressEntriesTable,
          ProjectProgressEntry
        > {
  $$ProjectProgressEntriesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $ProjectsTable _projectIdTable(_$AppDatabase db) => db.projects
      .createAlias('project_progress_entries__project_id__projects__id');
...
class $$ProjectProgressEntriesTableFilterComposer
    extends Composer<_$AppDatabase, $ProjectProgressEntriesTable> {
  $$ProjectProgressEntriesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ProjectProgressEntriesTableOrderingComposer
    extends Composer<_$AppDatabase, $ProjectProgressEntriesTable> {
  $$ProjectProgressEntriesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ProjectProgressEntriesTableAnnotationComposer
    extends Composer<_$AppDatabase, $ProjectProgressEntriesTable> {
  $$ProjectProgressEntriesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ProjectProgressEntriesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ProjectProgressEntriesTable,
          ...
          $$ProjectProgressEntriesTableOrderingComposer,
          $$ProjectProgressEntriesTableAnnotationComposer,
          $$ProjectProgressEntriesTableCreateCompanionBuilder,
          $$ProjectProgressEntriesTableUpdateCompanionBuilder,
          (ProjectProgressEntry, $$ProjectProgressEntriesTableReferences),
          ProjectProgressEntry,
          PrefetchHooks Function({bool projectId})
        > {
  $$ProjectProgressEntriesTableTableManager(
    _$AppDatabase db,
    $ProjectProgressEntriesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
              ...
              .map(
                (e) => (
                  e.readTable<
                    ...
                    ProjectProgressEntry
                  >(table),
                  $$ProjectProgressEntriesTableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$ProjectProgressEntriesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ProjectProgressEntriesTable,
      ProjectProgressEntry,
...
final class $$TasksTableReferences
  ...
  static MultiTypedResultKey<$AssetsTable, List<Asset>> _assetsRefsTable(
    ...
    db.assets,
    aliasName: 'tasks__id__assets__task_id',
  );
  ...
  _predecessorDependenciesTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.taskDependencies,
        aliasName: 'tasks__id__task_dependencies__predecessor_task_id',
      );

  $$TaskDependenciesTableProcessedTableManager get predecessorDependencies {
    final manager =
        $$TaskDependenciesTableTableManager($_db, $_db.taskDependencies).filter(
          (f) => f.predecessorTaskId.id.sqlEquals($_itemColumn<String>('id')!),
        );

    final cache = $_typedResult.readTableOrNull(
      _predecessorDependenciesTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  static MultiTypedResultKey<$TaskDependenciesTable, List<TaskDependency>>
  _successorDependenciesTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.taskDependencies,
        aliasName: 'tasks__id__task_dependencies__successor_task_id',
      );

  $$TaskDependenciesTableProcessedTableManager get successorDependencies {
    final manager =
        $$TaskDependenciesTableTableManager($_db, $_db.taskDependencies).filter(
          (f) => f.successorTaskId.id.sqlEquals($_itemColumn<String>('id')!),
        );

    final cache = $_typedResult.readTableOrNull(
      _successorDependenciesTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  Expression<bool> predecessorDependencies(
    ...
    final $$TaskDependenciesTableFilterComposer composer = $composerBuilder(
      ...
      getReferencedColumn: (t) => t.predecessorTaskId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
  ...
  Expression<bool> successorDependencies(
    Expression<bool> Function($$TaskDependenciesTableFilterComposer f) f,
  ) {
    final $$TaskDependenciesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.taskDependencies,
      getReferencedColumn: (t) => t.successorTaskId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
...
class $$TasksTableAnnotationComposer
  ...
  Expression<T> predecessorDependencies<T extends Object>(
  ...
  Expression<T> successorDependencies<T extends Object>(
    Expression<T> Function($$TaskDependenciesTableAnnotationComposer a) f,
  ) {
    final $$TaskDependenciesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            ...
            bool timeEntriesRefs,
            bool pomodoroSessionsRefs,
            bool predecessorDependencies,
            bool successorDependencies,
          })
        > {
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                ...
                timeEntriesRefs = false,
                pomodoroSessionsRefs = false,
                predecessorDependencies = false,
                successorDependencies = false,
              }) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    ...
                    if (timeEntriesRefs) db.timeEntries,
                    if (pomodoroSessionsRefs) db.pomodoroSessions,
                    if (predecessorDependencies) db.taskDependencies,
                    if (successorDependencies) db.taskDependencies,
                  ],
                  addJoins:
                      <
                        T extends TableManagerState<
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (assetsRefs)
                        await $_getPrefetchedData<Task, $TasksTable, Asset>(
                          currentTable: table,
                          referencedTable: $$TasksTableReferences
                              ._assetsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$TasksTableReferences(db, table, p0).assetsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.taskId == item.id,
                              ),
                      ...
                      if (predecessorDependencies)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$TasksTableReferences
                              ._predecessorDependenciesTable(db),
                          managerFromTypedResult: (p0) =>
                              $$TasksTableReferences(
                                db,
                                table,
                          ...
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.predecessorTaskId == item.id,
                              ),
                          typedResults: items,
                        ),
                      if (successorDependencies)
                        await $_getPrefetchedData<
                          Task,
                          $TasksTable,
                          TaskDependency
                        >(
                          currentTable: table,
                          referencedTable: $$TasksTableReferences
                              ._successorDependenciesTable(db),
                          managerFromTypedResult: (p0) =>
                              $$TasksTableReferences(
                                db,
                                table,
...
final class $$AssetsTableReferences
  ...
  static $ProjectsTable _projectIdTable(_$AppDatabase db) =>
      db.projects.createAlias('assets__project_id__projects__id');
  ...
  static $TasksTable _taskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias('assets__task_id__tasks__id');
...
class $$AssetsTableFilterComposer
  ...
  ColumnFilters<String> get uriOrPath => $composableBuilder(
    column: $table.uriOrPath,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get sensitiveJson => $composableBuilder(
    column: $table.sensitiveJson,
    builder: (column) => ColumnFilters(column),
  );
...
class $$AssetsTableOrderingComposer
  ...
  ColumnOrderings<String> get uriOrPath => $composableBuilder(
    column: $table.uriOrPath,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get sensitiveJson => $composableBuilder(
    column: $table.sensitiveJson,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$AssetsTableAnnotationComposer
  ...
  GeneratedColumn<String> get uriOrPath =>
      $composableBuilder(column: $table.uriOrPath, builder: (column) => column);
  ...
  GeneratedColumn<String> get sensitiveJson => $composableBuilder(
    column: $table.sensitiveJson,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> title = const Value.absent(),
                Value<String> uriOrPath = const Value.absent(),
                Value<String> note = const Value.absent(),
...
typedef $$AssetTagsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$AttachmentCategoriesTableCreateCompanionBuilder =
    AttachmentCategoriesCompanion Function({
      required String id,
      required String projectId,
      required String name,
      required int createdAt,
...
typedef $$AttachmentCategoriesTableUpdateCompanionBuilder =
    AttachmentCategoriesCompanion Function({
      Value<String> id,
      Value<String> projectId,
      Value<String> name,
...
final class $$AttachmentCategoriesTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $AttachmentCategoriesTable,
          AttachmentCategory
        > {
  $$AttachmentCategoriesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $ProjectsTable _projectIdTable(_$AppDatabase db) => db.projects
      .createAlias('attachment_categories__project_id__projects__id');
...
class $$AttachmentCategoriesTableFilterComposer
    extends Composer<_$AppDatabase, $AttachmentCategoriesTable> {
  $$AttachmentCategoriesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttachmentCategoriesTableOrderingComposer
    extends Composer<_$AppDatabase, $AttachmentCategoriesTable> {
  $$AttachmentCategoriesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AttachmentCategoriesTableAnnotationComposer
    extends Composer<_$AppDatabase, $AttachmentCategoriesTable> {
  $$AttachmentCategoriesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$AttachmentCategoriesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $AttachmentCategoriesTable,
          ...
          $$AttachmentCategoriesTableOrderingComposer,
          $$AttachmentCategoriesTableAnnotationComposer,
          $$AttachmentCategoriesTableCreateCompanionBuilder,
          $$AttachmentCategoriesTableUpdateCompanionBuilder,
          (AttachmentCategory, $$AttachmentCategoriesTableReferences),
          AttachmentCategory,
          PrefetchHooks Function({bool projectId})
        > {
  $$AttachmentCategoriesTableTableManager(
    _$AppDatabase db,
    $AttachmentCategoriesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$AttachmentCategoriesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$AttachmentCategoriesTableOrderingComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$AttachmentCategoriesTable, AttachmentCategory>(
                    table,
                  ),
                  $$AttachmentCategoriesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({projectId = false}) {
...
typedef $$AttachmentCategoriesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $AttachmentCategoriesTable,
      AttachmentCategory,
...
final class $$PomodoroSessionsTableReferences
  ...
  static $ProjectsTable _projectIdTable(_$AppDatabase db) =>
      db.projects.createAlias('pomodoro_sessions__project_id__projects__id');
...
final class $$TaskDependenciesTableReferences
  ...
  static $TasksTable _predecessorTaskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias('task_dependencies__predecessor_task_id__tasks__id');
  ...
  static $TasksTable _successorTaskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias('task_dependencies__successor_task_id__tasks__id');

  $$TasksTableProcessedTableManager get successorTaskId {
...
class $$TaskDependenciesTableFilterComposer
  ...
  $$TasksTableFilterComposer get successorTaskId {
    final $$TasksTableFilterComposer composer = $composerBuilder(
      composer: this,
...
class $$TaskDependenciesTableOrderingComposer
  ...
  $$TasksTableOrderingComposer get successorTaskId {
    final $$TasksTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.successorTaskId,
      referencedTable: $db.tasks,
...
class $$TaskDependenciesTableAnnotationComposer
  ...
  $$TasksTableAnnotationComposer get successorTaskId {
    final $$TasksTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.successorTaskId,
      referencedTable: $db.tasks,
...
class $$TaskDependenciesTableTableManager
    extends
        RootTableManager<
          ...
          TaskDependency,
          PrefetchHooks Function({bool predecessorTaskId, bool successorTaskId})
        > {
    ...
    $TaskDependenciesTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({predecessorTaskId = false, successorTaskId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$MilestonesTable, Milestone>(table),
...
class $AppDatabaseManager {
  ...
  $$ProjectProgressEntriesTableTableManager get projectProgressEntries =>
      $$ProjectProgressEntriesTableTableManager(
        _db,
        _db.projectProgressEntries,
      );
  ...
  $$AttachmentCategoriesTableTableManager get attachmentCategories =>
      $$AttachmentCategoriesTableTableManager(_db, _db.attachmentCategories);
